...
## Project Structure
    ...
    ├── testapiautosetting_115633  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115633`
...
2. Clone this repo and `cd testapiautosetting_115633`
